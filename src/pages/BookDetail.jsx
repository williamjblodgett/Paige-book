    ...
    <div className="min-h-screen">
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              <div className="flex justify-center md:justify-start mb-4">
                <BookMetadata book={book} accentColor={accent} />
              </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-12">
        ...
        {book.contentWarnings?.length > 0 && (
          <ContentWarnings warnings={book.contentWarnings} accentColor={accent} />
        )}
        ...
        <nav className="bg-surface rounded-lg border border-gold/10 p-6">
          ...
          <div className="flex flex-wrap gap-3">
            {book.synopsis && (
              <a href="#synopsis" className="font-body text-sm text-gold hover:underline">About</a>
            )}
